            ...
            <ScrollView style={{ flex: 1, padding: 20 }}>
                ...
                <View style={{ backgroundColor: 'white', padding: 20, borderRadius: 12, marginBottom: 20 }}>
                    ...
                    <View style={{ marginTop: 15 }}>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Standard hand signal guide</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Visual signal demonstrations</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Signal meaning explanations</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Emergency stop signals</Text>
                        <Text style={{ fontSize: 14, color: '#666' }}>• Multi-crane operation signals</Text>
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView>
