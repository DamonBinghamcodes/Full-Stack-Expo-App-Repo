            ...
            <ScrollView style={{ flex: 1, padding: 20 }}>
                ...
                <View style={{ backgroundColor: 'white', padding: 20, borderRadius: 12, marginBottom: 20 }}>
                    ...
                    <View style={{ marginTop: 15 }}>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Rigging equipment catalog</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Safety gear and PPE</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Measurement tools</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Professional training materials</Text>
                        <Text style={{ fontSize: 14, color: '#666' }}>• Secure payment processing</Text>
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView>
