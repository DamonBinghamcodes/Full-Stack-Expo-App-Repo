            ...
            <ScrollView style={{ flex: 1, padding: 20 }}>
                <View style={{ alignItems: 'center', marginBottom: 30 }}>
                    ...
                    <Text style={{ fontSize: 16, color: '#666', textAlign: 'center' }}>
                        Track and manage your lifting operations
                    </Text>
                </View>
                ...
                <View style={{ backgroundColor: 'white', padding: 20, borderRadius: 12, marginBottom: 20 }}>
                    ...
                    <View style={{ marginTop: 15 }}>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Lift operation logging</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Equipment tracking</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Safety checklist management</Text>
                        <Text style={{ fontSize: 14, color: '#666', marginBottom: 8 }}>• Historical lift records</Text>
                        <Text style={{ fontSize: 14, color: '#666' }}>• Compliance reporting</Text>
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView>
